...
C***********************************************************************
C
C f77 -O -o cloud Cloud15.f
C ifort -132 Cloud15.f -o cloud.exe
...
C
  ...
  260 FORMAT(69X, 'NH3 - H2O Solution'/ ' '/ 3X, 'Z', 7X, 'T', 8X, 'P',
     1  6X, 'DT/DZ', 5X, 'Cp H2', 6X, 'Cp Atm', 5X, 'W', 8X, 'Conc.',
     2  5X, 'Delta', 3X, 'Conc. H2S'/ 2X, '(km)', 4X, '(K)', 5X,
     3  '(bars)', 3X, '(K/km)', 2X, '(Erg/M-K)', 2X, '(Erg/M-K)', 2X,
...
C
      ...
      PP = P(J) * Q3
C
      WRITE(3,500) ZZ, T(J), PP, DTDZZ, CPH2, CP, W, C(J), DC, CH2S
  500 FORMAT(1X, F5.1, 2X, F6.2, 2X, 1PE9.3, 2X, 0PF6.3, 2X, 1PE9.3,
     1  2X, 1PE9.3, 2X, 0PF5.2, 5X, 0PF7.5, 2X, 0PF8.5, 2X, 1PE8.2)
